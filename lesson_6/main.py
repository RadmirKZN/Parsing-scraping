...
def get_data_with_selenium(url):
    ...
    options.set_preference("general.useragent.override", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit / 537.36(KHTML, like Gecko) Chrome / 99.0 .4844 .51 Safari / 537.36")

    # try:
    #     driver = webdriver.Firefox(
    #         executable_path="/home/radmir/PycharmProjects/parser_6/geckodriver",
    #         options=options
    #     )
    #     driver.get(url=url)
    #     time.sleep(8)
