...
def get_data():
    ...
    url = "https://roscarservis.ru/catalog/legkovye/?sort%5Bprice%5D=asc&sort%5Brecommends%5D=desc&form_id=catalog_filter_form&filter_mode=params&filter_type=tires&arCatalogFilter_458_1500340406=Y&set_filter=Y&PAGEN_1=1"
    ...
    for page in range(1, pages_count + 1):
        url = f"https://roscarservis.ru/catalog/legkovye/?sort%5Bprice%5D=asc&sort%5Brecommends%5D=desc&form_id=catalog_filter_form&filter_mode=params&filter_type=tires&arCatalogFilter_458_1500340406=Y&set_filter=Y&PAGEN_1={pages_count}"
